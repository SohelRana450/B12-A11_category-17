...
const Login = () => {
    ...
    <div className=" card-body bg-base-100 w-full max-w-lg py-6 rounded-xl shadow-2xl">
<h1 className="text-5xl text-center font-bold">Login now!</h1>
      <form onSubmit={handleSubmit(onSubmit)} className="">
        ...
        <fieldset className="fieldset">
          ...
          <button type="submit" className="btn btn-active font-medium border-0 bg-[#bde0fe] mt-4">Log In</button>

...
const Register = () => {
  ...
  <input
    id='fileUpload'
    type="file"
    className="file-input-accent cursor-pointer bg-[#bde0fe] text-black font-medium px-10 py-2 rounded-lg hover:bg-[#ffc8dd]"
  ...
  {errors.image?.type === 'required' && <p className='text-red-500 pt-2'>Image is required</p>}
       ...
       <div className='relative'>
          ...
          {errors.password?.type === 'minLength' && <p className='text-red-500 pt-2 font-medium '>Password must have at least one uppercase, one lowercase, and be 6+ characters long.</p>}
       </div>
